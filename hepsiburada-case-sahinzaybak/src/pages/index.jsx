...
const Index = () => {
  ...
  if (voteList.length != 0) localStorage.setItem("voteList", JSON.stringify(voteList)) 

  useEffect(() => {
    if (JSON.parse(localStorage.getItem("voteList")) != null) dispatch(loadVoteLocalStorage())
  }, []);
  ...
  const orderData = [{ id: 0, label: "Most Voted (Z - A)" }, { id: 1, label: "Less Voted (A - Z)" }]; //dropdown
      ...
      <div className="custom-container">
        <div className="vote-wrp">
          <div className="vote-header">
            <DropDown placeholder="Order by" orderData={orderData}/>
